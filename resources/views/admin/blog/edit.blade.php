	              	...
	              	<div class="col s12 m12 l12">
	              		<form method="POST" action="{{ route('article.update', $article->id) }}" enctype="multipart/form-data">
		              		...
		              		<div class="row">
							      ...
							      <input type="file" name="imageurl" id="input-file-now" class="dropify" data-default-file="../../../images/article/{{ $article->imageurl }}" value="{{ $article->imageurl }}"/>
							    </div>
			              	</div>
			              	<div class="row">
			              		<div class="input-field col s12 m12 l12">
					              	<input type="text" name="name" id="name" class="validate" required value="{{$article->name}}">
			              	...
			              	<div class="row">
			              		...
			              		<div class="col s12 m12 l12">
			              			<textarea id="kcontent" name="kcontent">{{ $article->content }}</textarea>
			              		</div>
			              	</div>
			              	<div class="row">
			              		<div class="col s12 m12 l12 mt-2">
			              			<button class="btn deep-purple accent-2 waves-effect waves-light right" type="submit" name="action">Saves
	                  				</button>
